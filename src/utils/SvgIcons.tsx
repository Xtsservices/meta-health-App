...
export const CalendarClockIcon = ({ size = 24, color = "#000000" }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    {/* Calendar base */}
    <Rect x="3" y="4" width="18" height="18" rx="2" ry="2" stroke={color} strokeWidth={2} strokeLinecap="round" strokeLinejoin="round"/>
    ...
    {/* Clock */}
    <Circle cx="12" cy="15" r="4" stroke={color} strokeWidth={2} strokeLinecap="round" strokeLinejoin="round"/>
    <Path d="M12 13v2l1.5 1.5" stroke={color} strokeWidth={2} strokeLinecap="round" strokeLinejoin="round"/>
  </Svg>
);
export const ChevronRight: React.FC<IconProps> = ({ size = 24, color = "#000000", strokeWidth = 2.5 }) => {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Path
        d="M9 18L15 12L9 6"
...
export const TrashIcon: React.FC<IconProps> = ({ size = 24, color = "#000000", strokeWidth = 2 }) => {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Path
        d="M3 6H5H21"
...
export const XCircleIcon: React.FC<IconProps> = ({ size = 24, color = "#000000", strokeWidth = 2 }) => {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Path
...
export const CommissionIcon = (props: any) => (
  <Svg width={props.size || 24} height={props.size || 24} viewBox="0 0 24 24" fill="none" {...props}>
    <Path d="M12 2C6.48 2 2 6.48 2 12C2 17.52 6.48 22 12 22C17.52 22 22 17.52 22 12C22 6.48 17.52 2 12 2ZM12 20C7.59 20 4 16.41 4 12C4 7.59 7.59 4 12 4C16.41 4 20 7.59 20 12C20 16.41 16.41 20 12 20Z" fill={props.color || "#000"}/>
    <Path d="M12 6C8.69 6 6 8.69 6 12C6 15.31 8.69 18 12 18C15.31 18 18 15.31 18 12C18 8.69 15.31 6 12 6ZM14.31 14.69L11.12 12.83V8H12.88V12.17L15.5 13.5L14.31 14.69Z" fill={props.color || "#000"}/>
  </Svg>
);
