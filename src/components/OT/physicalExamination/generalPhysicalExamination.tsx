...
const CHECKBOX_ITEMS: { key: keyof GeneralPhysicalExaminationState; label: string }[] = [
  { key: "jvp",            label: "JVP" },
  ...
  { key: "syncopatAttack", label: "Syncopat Attack" },
  { key: "paipitation",    label: "Paipitation" },
...
const GeneralPhysicalExaminationMobile: React.FC = () => {
  ...
  const { generalphysicalExamination, setGeneralPhysicalExamination } =
    usePhysicalExaminationForm() as {
      generalphysicalExamination: GeneralPhysicalExaminationState;
      setGeneralPhysicalExamination: (
        patch: Partial<GeneralPhysicalExaminationState>
      ) => void;
    };
  ...
  const handleNext = () => {
    navigation.navigate("Mallampati" as never);
  };
          ...
          >
            ...
            <View style={styles.checkboxGroup}>
              {CHECKBOX_ITEMS.map((item) => {
                const checked = Boolean(generalphysicalExamination?.[item.key]);
                return (
                  <Pressable
                    key={item.key}
