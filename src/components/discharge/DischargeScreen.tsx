        ...
        <View style={[styles.dropdownContainer, { backgroundColor: COLORS.dropdownBg }]}>
          ...
          <FlatList
            ...
            renderItem={({ item }) => (
              ...
              >
                <Text
                  style={[styles.dietItemText, { color: COLORS.text }]}
                  numberOfLines={1}
                  ellipsizeMode="tail"
                >
                  {item?.name}
      ...
      >
        <ScrollView
          ...
          contentContainerStyle={{
            flexGrow: 1,
            paddingBottom: RESPONSIVE.spacing.xxl * 2, // Extra padding for keyboard
          }}
                ...
                {formData?.dischargeType === 1 && (
                  <>
                    ...
                    <View style={styles.formGroup}>
                      ...
                      >
                        <Text
                          style={[styles.dietDropdownText, { color: selectedDiets?.length > 0 ? COLORS.text : COLORS.sub }]}
                          numberOfLines={1}
                          ellipsizeMode="tail"
                        >
