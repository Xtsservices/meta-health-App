...
import { FONT_SIZE, responsiveHeight, responsiveWidth, SPACING ,SCREEN_WIDTH} from "../../../utils/responsive";
...
SelectText: {
  fontSize: FONT_SIZE.md,          // ✅ SMALLER TEXT (THIS IS THE KEY)
  color: "#111827",
  fontWeight: "500",
},
...
hiddenPicker: {
  ...
  opacity: 0,                      // 👈 Picker still clickable
},
